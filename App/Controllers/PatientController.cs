    ...
    public class PatientController : Controller
    {
        ...
        public async Task<IActionResult> AddPicture(InvestigationImagesModel imageFiles, CancellationToken cancellationToken)
        {
            if (imageFiles != null)
            {
                ...
                if (imageFiles.PatientId > 0 && imageFiles.Id>0 && imageFiles.Msg != "save")
                {
                    try
                    {
                ...
                if (imageFiles.Msg == "save")
                {
                    ...
                    var _InvestigationImgId = _patient.PictureDetail(_PatientId);
        ...
        //[HttpPost]
        //public async Task<IActionResult> OperationSheet(OperationModel model)
        //{
        //    if (model != null)
        //    {
        //        string msg;
        ...
        //        //if (perhapsImage != null && perhapsImage.Length > 0)
        //        //{
        //        //    var fileName = Guid.NewGuid().ToString() + Path.GetExtension(perhapsImage.FileName);
        //        //    var filePath = Path.Combine("wwwroot/Images_Data", fileName); // Adjust the path as needed

        //        //    using (var stream = new FileStream(filePath, FileMode.Create))
        //        //    {
        //        //        await perhapsImage.CopyToAsync(stream);
        //        //    }

        //        //    model.PerhapsImage = fileName;
        //        //}
        ...
        //        return Json("Invalid data received");
        //    }
        ...
        //[HttpPost]
        //public IActionResult Outcome([FromForm] PatientViewModel viewModel)
        //{
        //    if (viewModel != null)
        //    {
        ...
        //        {
        //            string msg = "";
        //            var check = _patient.AddOutCome(viewModel.Outcome, _PatientId);
        //            if (check > 0)
        //            {
        //                msg = "Data added successfully";
        //            }
        ...
        //            return Json(msg);
        //        }
        //        return Json("PatientId is not valid");
        //    }
        //    return Json("Invalid data received");
        //}
        ...
        public IActionResult Outcome(string model)
        {
            ...
            {
                string msg;
                var _model = JsonConvert.DeserializeObject<List<OutcomeModel>>(model).FirstOrDefault();
                if (_model.Id > 0)
                {
